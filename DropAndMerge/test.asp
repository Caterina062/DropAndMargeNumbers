...
%prendo indice di riga per sotto e lati, genera per ogni colonna la cella dove può cadere il blocco, quindi il primo blocco libero
...
%scegliere il blocco vicino con valore più grande in modo da fare il merge
