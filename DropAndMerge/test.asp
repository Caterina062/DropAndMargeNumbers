...
:-move(X), move(Y), X!=Y.
 cell(0,0,0). cell(0,1,0). cell(0,2,0). cell(0,3,0). cell(0,4,0). cell(1,0,0). cell(1,1,0). cell(1,2,0). cell(1,3,0). cell(1,4,0). cell(2,0,0). cell(2,1,0). cell(2,2,0). cell(2,3,0). cell(2,4,0). cell(3,0,0). cell(3,1,0). cell(3,2,0). cell(3,3,0). cell(3,4,0). cell(4,0,0). cell(4,1,0). cell(4,2,0). cell(4,3,0). cell(4,4,0). cell(5,0,0). cell(5,1,0). cell(5,2,0). cell(5,3,0). cell(5,4,0). block(2).
% Una cella non può contenere più di un numero alla volta
%cell(0,0,0). cell(0,1,0). cell(0,2,0). cell(0,3,0). cell(0,4,0).
%cell(1,0,0). cell(1,1,0). cell(1,2,0). cell(1,3,0). cell(1,4,0).
%cell(2,0,0). cell(2,1,0). cell(2,2,0). cell(2,3,0). cell(2,4,0).
...
:-move(X), move(Y), X!=Y.
 cell(0,0,0).
 cell(0,1,0). cell(0,2,0). cell(0,3,0). cell(0,4,0). cell(1,0,0). cell(1,1,0). cell(1,2,0). cell(1,3,0). cell(1,4,0).
 cell(2,0,0). cell(2,1,0). cell(2,2,0). cell(2,3,0). cell(2,4,0). cell(3,0,0). cell(3,1,0). cell(3,2,0). cell(3,3,0). cell(3,4,0).
 cell(4,0,0). cell(4,1,0). cell(4,2,0). cell(4,3,0). cell(4,4,0). cell(5,0,2). cell(5,1,0). cell(5,2,0). cell(5,3,0). cell(5,4,0). block(8).